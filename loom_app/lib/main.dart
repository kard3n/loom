...
class Compose extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor:
            theme.scaffoldBackgroundColor, // Hintergrundfarbe des Scaffolds
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('Totem-Typ', style: theme.textTheme.titleMedium),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('Oder teile über:', style: theme.textTheme.titleMedium),
